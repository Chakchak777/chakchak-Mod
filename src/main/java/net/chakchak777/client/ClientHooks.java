...
public class ClientHooks {
    ...
    public static void handleDialogueLine(SentDialogueLine packet, IPayloadContext context) {
        context.enqueueWork(() -> {
            DialogueLineClientState.showLine(packet.text(), packet.icon(), packet.durationTicks());
        });
    }
